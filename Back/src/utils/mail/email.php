...
function email($address, $nome, $subject, $body)
{
    ...
    $mail->Username = "noreply.flex.am@gmail.com";
    //Password to use for SMTP authentication
    $mail->Password = "81861501";
    //Set who the message is to be sent from
    $mail->setFrom('noreply.flex.am@gmail.com', 'Notificação de Expiração - FLEX');
...
//    $mail->addReplyTo('replyto@example.com', 'First Last');
    ...
    $mensagemConcatenada .= 'E-mail: '.$address.'<br/>'; 
    $mensagemConcatenada .= 'Assunto: '.$subject.'<br/>';
    $mensagemConcatenada .= '-------------------------------<br/><br/>'; 
